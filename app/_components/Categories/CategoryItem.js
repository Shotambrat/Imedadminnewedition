  ...
  return (
    ...
    >
      <div className="mdl:flex flex-col mdl:items-center max-mdl:max-w-[167px] flex items-start h-full ">
        <h2 className=" max-mdx:text-[18px] lh text-2xl mb-2 font-semibold mdl:text-center z-10 mx-auto max-mdl:mb-[5px]">{title ? title : ''}</h2>
      ...
      <div className="mdl:flex mdl:flex-col mdl:items-center flex-1 max-mdl:flex max-mdl:justify-end">
        <Image
          ...
          height={500}
          alt={`${title} Photo`}
          className="absolute h-full max-mdx:max-w-[157px] z-0 object-contain -bottom-10 mdl:-bottom-20 mdl:w-[60%] mdl:h-[90%] max-mdl:w-auto max-mdl:h-full max-mdl:right-0"
        />
      </div>
    </div>
  );
