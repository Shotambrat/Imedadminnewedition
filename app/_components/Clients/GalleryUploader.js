...
const GalleryUploader = ({ gallery, setGallery, setGalleryDeleteList }) => {
  ...
  const handleDeleteImage = (index) => {
    ...
    const forDeleteList = gallery.find((_, i) => i == index);
    setGalleryDeleteList((prevList) => {
      return [...prevList, forDeleteList.id]
    })
